...
import com.lankydanblog.tutorial.http.flows.HttpRequestSendMessageFlow
...
//  @PostMapping("/new")
//  fun new(@RequestBody message: MessageDto) {
//    log.info("Received a new message")
//  }
//
//  @PostMapping("/signed")
//  fun signed(@RequestBody message: MessageDto) {
//    log.info("Signed a message")
//  }
//
//  @PostMapping("/committed")
//  fun committed(@RequestBody message: MessageDto) {
//    log.info("Committed a message")
//  }
